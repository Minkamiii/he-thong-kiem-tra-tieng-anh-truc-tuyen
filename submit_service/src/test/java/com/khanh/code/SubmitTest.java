...
public class SubmitTest {
    ...
    void setup() {
        ...
        testID = "68d13a9cc35d63eb8543f27d";

        submitRequest.setUser_id("a68feeb1-14f5-435d-bb44-09700b3560fe");
        submitRequest.setTest_id(testID);
    ...
    void SUBMIT_016_add_Submit_Reading_Success() {
        ...
        assertEquals(submit.getId_test(), testID);
    ...
    void SUBMIT_021_add_Submit_Two_Answer_For_One_Question() {
        ...
        ApiResponse response = submitService.saveSubmit(submitRequest);
        assertEquals(400, response.getStatus());
        assertEquals("Answer for question with ID " + answer2.getId_question() + " already exists.",
                response.getMessage());
    ...
    @Test
    void SUBMIT_044_GetTestProgressForAdmin_Writing() {
        ...
        assertEquals(data.get("lowest"), null);
        assertEquals(data.get("100%_answered_wrong_question"), null);
    }

    @Test
    void SUBMIT_045_GetTestProgressForAdmin_ReadOrListen() {
        String testID = "68feed2e1a58077bfe55c22d";
        ...
        assertEquals(data.get("lowest"), 0);
        assertInstanceOf(List.class,data.get("100%_answered_wrong_question"));

        List<?> wrongQuestions = (List<?>) data.get("100%_answered_wrong_question");
        assertEquals(33, wrongQuestions.size()); 
        assertInstanceOf(String.class, wrongQuestions.get(0));

        String id_question1 = (String) wrongQuestions.get(0);
        assertEquals("68feed2e1a58077bfe55c227", id_question1);
    }
